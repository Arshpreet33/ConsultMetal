...
const ServiceDetailPage = () => {
  ...
  const isCadDevelopment = slug === 'cad-development';
      ...
      <section className="service-detail-content">
        <div className="container">
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            {isCadDevelopment ? (
              /* CAD Development Custom Layout */
              <>
                {/* Row 1: Image (left) + Title & Description (right) */}
                <div className="service-detail-grid">
                  <div>
                    <img 
                      src="/images/services/cad-development-2.jpg"
                ...
                {/* Row 2: Bulleted Points (left) + Second Image (right) */}
                <div className="service-detail-grid cad-second-row">
                  <div>
                    {service.details && (
                  ...
                  <div>
                    <img 
                      src="/images/services/cad-development-3.jpg"
                      alt={`${getText(service.name)} - Detail`}
                      className="service-image"
                      style={{ 
                        transition: 'all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)',
                        cursor: 'pointer'
